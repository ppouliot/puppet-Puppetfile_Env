...
mod 'sonarqube',  :git => "#{base_url}/maestrodev/puppet-sonarqube",  :tag => 'v2.6.6'  #PRODUCTION
...
mod 'petools',             :git => "#{ssh_url}/openstack-hyper-v/puppet-petools" #PRODUCTION #WINDOWS
...
mod 'windows_common',      :git => "#{ssh_url}/openstack-hyper-v/puppet-windows_common" #PRODUCTION #WINDOWS
mod 'windows_freerdp',     :git => "#{ssh_url}/openstack-hyper-v/puppet-windows_freerdp" #PRODUCTION #WINDOWS
mod 'windows_git',         :git => "#{ssh_url}/openstack-hyper-v/puppet-windows_git" #PRODUCTION #WINDOWS
mod 'windows_7zip',        :git => "#{ssh_url}/openstack-hyper-v/puppet-windows_7zip" #PRODUCTION #WINDOWS
mod 'windows_openssl',     :git => "#{ssh_url}/openstack-hyper-v/puppet-windows_openssl" #PRODUCTION #WINDOWS
mod 'windows_chrome',      :git => "#{ssh_url}/openstack-hyper-v/puppet-windows_chrome" #PRODUCTION #WINDOWS
mod 'java',                :git => "#{ssh_url}/openstack-hyper-v/puppetlabs-java" #PRODUCTION
mod 'windows_python',      :git => "#{ssh_url}/openstack-hyper-v/puppet-windows_python" #PRODUCTION #WINDOWS
mod 'hyper_v',             :git => "#{ssh_url}/openstack-hyper-v/puppet-hyper_v" #PRODUCTION #WINDOWS
mod 'network_mgmt',        :git => "#{ssh_url}/openstack-hyper-v/puppet-network_mgmt" #PRODUCTION
mod 'mingw',               :git => "#{ssh_url}/openstack-hyper-v/puppet-mingw" #PRODUCTION #WINDOWS
...
mod 'visualcplusplus2008', :git => "#{ssh_url}/openstack-hyper-v/puppet-visualcplusplus2008" #PRODUCTION #WINDOWS
mod 'visualcplusplus2010', :git => "#{ssh_url}/openstack-hyper-v/puppet-visualcplusplus2010" #PRODUCTION #WINDOWS
mod 'visualcplusplus2012', :git => "#{ssh_url}/openstack-hyper-v/puppet-visualcplusplus2012" #PRODUCTION #WINDOWS
...
mod 'autofs',   :git => "#{base_url}/pdxcat/puppet-module-autofs",     :tag => 'v1.1.0' #PRODUCTION
...
mod 'drbd',                       :git => "#{base_url}/voxpupuli/puppet-drbd",                       :tag => '0.1.0'  #PRODUCTION
...
mod 'healthcheck',                :git => "#{base_url}/voxpupuli/puppet-healthcheck"                                  #PRODUCTION
mod 'nagios_providers',           :git => "#{base_url}/voxpupuli/puppet-nagios_providers"                             #PRODUCTION
mod 'community_kickstarts',       :git => "#{base_url}/voxpupuli/puppet-community_kickstarts",       :tag => 'v0.2.3' #PRODUCTION
